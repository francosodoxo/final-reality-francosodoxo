...
public abstract class AbstractCharacterTest {
  ...
  protected IWeaponKnight testWeaponKnight;
  protected IWeaponEngineer testWeaponEngineer;
  protected IWeaponThief testWeaponThief;
  protected IWeaponBlack testWeaponBlack;
  protected IWeaponWhite testWeaponWhite;
...
/*
  ...
  protected void basicSetUp() {
    ...
    testWeaponKnight = new Axe("Test", 15, 10);
    testWeaponBlack = new Knife("Test",10,15);
    testWeaponEngineer = new Bow("Test",15,10);
    testWeaponThief = new Bow("TestB",15,10);
    testWeaponWhite = new Staff("Test",15,10);
  ...
  public IWeaponKnight getTestWeaponKnight(){
    return testWeaponKnight;
  }

  public IWeaponBlack getTestWeaponBlack(){
    return testWeaponBlack;
  }
  public IWeaponEngineer getTestWeaponEngineer(){
    return testWeaponEngineer;
  }
  public IWeaponThief getTestWeaponThief(){
    return testWeaponThief;
  }
  public IWeaponWhite getTestWeaponWhite(){
    return testWeaponWhite;
  }
